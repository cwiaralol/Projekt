 ...
 <head>
  ...
  <body>  
    ...
    <form class ="col-md-2" action="controlPanel" method=GET>
  	<input type="hidden" name="command" value="controlOperation" />
    <input type=submit class="btn btn-success" value="Kontrola czynności">
    </form>
    
    <form class ="col-md-2" action="controlPanel" method="GET">
  	<input type="hidden" name="command" value="controlActivsX" />
    ...
    <input type=submit class="btn btn-warning" value="Kontrola operacji mechaników">
    </form>
    ...
    <tr>
  	...
  	<c:when test="${command == 'controlOperation' || command == 'filterProducts'}">
    ...
    <tr>
      <th scope="row"><c:out value="${temp.getStatus_id()}"/></th>
      ...
      <td><c:out value="${temp.getDescription()}"/></td>
   	...
   	<tr>
   		...
   		<td></td>
   		<td></td>
   		<td><form action="addOperationX" method="GET">
   	 	<input type=submit class="btn btn-sm btn-success btn-block" value="Dodaj nową czynność">
    	</form></td>
   	</tr>
  	</tbody>
	</table>
  ...
  <td><c:out value="${temp.getOrderId()}"/></td>
      ...
      <td><c:out value="${temp.getMechanicName()}"/></td>
    </tr>
   	</c:forEach>
  	</tbody>
	</table>
